...
sending.sendMsg(update.getMessage(),"Quest was successfully added✅"+"\n It will be checked , and after that it will apper.");
                }
                    ...
                    if (arrayListQuests.size() == currentlyQuest) {
                        ...
                        switch (points) {
                            ...
                            case 10:
                                ...
                                break;
                                default:sending.sendMsg(update.getMessage(),"Your rank is EnglishVeryPro\uD83E\uDD11");
                                break;
                        }
